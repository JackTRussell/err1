@ST_20536 @tagtagtag @this_is_story_tag
...
@SC_87563 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_87564 @third_scenario_tag
...
@SC_87565 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_87566 @fifth_scenario_tag
